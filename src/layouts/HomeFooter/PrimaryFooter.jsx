...
export default function PrimaryFooter() {
  return (
    <footer aria-label="primary-footer" className="bg-neutral-100">
      <div className="container tablet:px-10 laptop:px-20 | py-12 tablet:py-20">
        <div className="grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 min-[1360px]:gap-x-[92px] gap-10 | max-tablet:max-w-sm max-tablet:mx-auto max-tablet:text-center">
          <div className="space-y-7 | tablet:max-laptop:col-span-2">
            {/* logo */}
            <motion.div initial={{ y: -100, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }}>
              <TextLogo />
            </motion.div>
            ...
            {/* social links */}
            <motion.div variants={linkContainerVariant} initial="hidden" whileInView="visible">
              <Navigation
              ...
              >
                {[
                  ...
                  <motion.li variants={linkChildVariant} key={index} aria-label={navItem}>
                ...
                <Navigation ariaLabel="market place navigation" navExtraClasses="" ulExtraClasses="flex flex-col gap-3">
                  {[
                    ...
                    <motion.li variants={navLinkChildVariant} key={index}>
                      <a
                        className="cursor-pointer font-medium transition-all hover:text-primary hover:underline hover:underline-offset-2"
                        href={url}
                      >
                        {navItem}
                      </a>
          ...
          <div className="space-y-8">
            {/* title */}
            <h3 className="text-600 font-bold">Stay In The Loop</h3>
